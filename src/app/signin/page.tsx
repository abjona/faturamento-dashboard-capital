...
export default function SignIn() {
  ...
  return (
    <div className="mx-auto flex h-[100vh] max-w-screen-2xl items-center justify-center p-4 sm:p-0 md:p-6 2xl:p-10">
        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              {error.message != "" && (
                <AlertaErro message={error.message} title={error.title} />
              )}
              ...
              <div className="mb-5">
                ...
                {loading && (
                  <div className="flex flex-row items-center justify-center">
                    <div className="h-6 w-6 animate-spin rounded-full border-4 border-solid border-primary border-t-transparent" />
                  </div>
                )}
              </div>
            </div>
